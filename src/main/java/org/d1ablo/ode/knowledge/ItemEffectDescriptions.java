...
/**
 * Contains the various item effects that can be applied to unique items.
 */
public class ItemEffectDescriptions {

    public static final String[] ITEM_EFFECTS = {       //Byte value to obtain item effect
            "+% ToHit",                                 //00
            "-% ToHit",                                 //01
            "+% damage done",                           //02
            "-% damage done",                           //03
